...
export interface ScrollEngine {
  ...
  to(surface: ScrollSurface, destination: Partial<Point>, options?: ScrollOptions): Promise<ExecutedScrollStep>
  by(surface: ScrollSurface, delta: Partial<Point>, options?: ScrollOptions): Promise<ExecutedScrollStep>
