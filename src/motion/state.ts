...
export function resolveMotion(motion: MotionOptions | MotionPreset | undefined): MotionOptions {
  ...
  if (motion === "snappy") return { type: "tween", duration: { type: "adaptive", min: 120, max: 420, velocity: 1200 }, easing: easeOut }
  if (motion === "gentle") return { type: "tween", duration: { type: "adaptive", min: 240, max: 900, velocity: 2200 }, easing: easeOut }
  return motion
}
